  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-12.mb-5.bgs.p-4.brad
        figure
          img(src="@/assets/curso/sintesis.svg", alt="La síntesis  resume las temáticas que se estructuran el componente formativo, entre las cuales están las clases de aprovechamiento y trámite para los permisos otorgados por la autoridad ambiental, recursos forestales no maderables como materia prima, recolección y ejemplos de manufactura de productos.")
      .col-auto
